    ...
    <section className="py-32 px-6 bg-white text-gray-900 text-center">
      ...
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
        <div className="bg-[#F3F9FC] rounded-lg shadow-md overflow-hidden">
          <Image
            src="/course-img1.jpg"
            alt="Curso inicial de arbitraje"
            width={500}
            height={500}
          ...
          <div className="p-6">
            <h3 className="text-xl font-semibold mb-2">
              Curso inicial de arbitraje
            </h3>
            <p className="text-sm text-gray-700">
              Ideal para quienes dan sus primeros pasos en el arbitraje. Incluye
      ...
      <div className="p-6">
        ...
        <div className="bg-[#F3F9FC] rounded-lg shadow-md overflow-hidden">
          <Image
            ...
            width={500}
            height={500}
            alt="Seminarios de VAR y reglamento FIFA"
            className="w-full h-48 object-cover"
          />
          <div className="p-6">
            <h3 className="text-xl font-semibold mb-2">
              Seminarios de VAR y reglamento FIFA
            </h3>
            <p className="text-sm text-gray-700">
              Actualizate con las últimas reglas y tecnología usada en el
        ...
        <div className="bg-[#F3F9FC] rounded-lg shadow-md overflow-hidden sm:col-span-2 lg:col-span-1">
          <Image
            ...
            width={500}
            height={500}
            alt="Charlas con árbitros profesionales"
            className="w-full h-48 object-cover"
          />
          <div className="p-6">
            <h3 className="text-xl font-semibold mb-2">
              Charlas con árbitros profesionales
            </h3>
            <p className="text-sm text-gray-700">
              Conocé la experiencia real de quienes ya ejercen. Preguntas,
